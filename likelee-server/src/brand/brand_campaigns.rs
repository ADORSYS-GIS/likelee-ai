use crate::{
    admin::activity::{log_activity_event, log_activity_event_with_subject},
    auth::AuthUser,
    billing::entitlements::{
        brand_allows_campaign_collaboration, brand_campaign_limit, get_brand_plan_tier, PlanTier,
    },
    billing::pricing_defaults::should_default_visibility_on,
    config::AppState,
...
pub async fn respond_to_campaign_offer(
    ...
    if action == "accept" {
        ...
        tokio::spawn(async move {
            ...
            let _ = crate::messaging::notifications::notify_brand_if_enabled(
                &state_clone,
                crate::messaging::notifications::BrandNotificationRequest {
