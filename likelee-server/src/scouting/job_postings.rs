use crate::{
    admin::activity::log_activity_event_with_subject,
    auth::AuthUser,
    brand::brand_campaigns::{resolve_agency_name, resolve_brand_name, resolve_creator_name},
    config::AppState,
...
async fn send_job_invitation_notifications(
    ...
    for email in all_emails {
        let _ =
            crate::messaging::email::send_plain_text_email(state, &email, &subject, &body, Some(brand_name));
    }
}
