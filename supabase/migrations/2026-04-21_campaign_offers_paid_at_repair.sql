...
-- Repair legacy paid_at rows that were previously backfilled from updated_at,
-- which can overstate "This Month's Spend" when old paid offers were edited later.
