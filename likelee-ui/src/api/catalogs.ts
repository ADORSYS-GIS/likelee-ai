...
export const catalogApi = {
  ...
  eligibleRequests: () =>
    base44Client.get("/agency/catalogs/eligible-requests"),
  create: (data: any) => base44Client.post("/agency/catalogs", data),
  remove: (id: string) => base44Client.delete(`/agency/catalogs/${id}`),
  getPublic: (token: string) => base44Client.get(`/public/catalogs/${token}`),
  ...
  getSignedRecordingUrl: (recordingId: string) =>
    base44Client.get(`/voice/recordings/signed-url`, {
