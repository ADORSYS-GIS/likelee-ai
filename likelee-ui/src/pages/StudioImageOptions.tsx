...
export default function StudioImageOptions() {
  ...
  const handleOptionSelect = (optionId) => {
    navigate(
      createPageUrl("StudioImage") + `?model=${modelId}&mode=${optionId}`,
    );
  };
      ...
      <section className="px-6 py-20">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">Choose your creation method</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {imageOptions.map((option) => (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-xl bg-gradient-to-br ${option.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                >
