...
import { CheckCircle2, ArrowRight, ArrowLeft, Upload, AlertCircle } from "lucide-react";
...
export default function CreatorSignup() {
  ...
  const createInitialProfileMutation = useMutation({
    ...
    onError: (error) => {
      ...
      alert("Failed to create initial profile. Please check your inputs and try again.");
    }
  });
  ...
  const updateProfileMutation = useMutation({
    mutationFn: async (dataToUpdate) => {
      if (!profileId) {
        throw new Error("Profile ID not found for update. Please complete Step 1 first.");
      }

      let finalProfilePhotoUrl = dataToUpdate.profile_photo_url;

      if (profilePhotoFile) {
        const { file_url } = await base44.integrations.Core.UploadFile({ file: profilePhotoFile });
  ...
  const handleNext = () => {
    if (step === 1) {
      ...
      if (!formData.instagram_handle && !formData.tiktok_handle && !formData.youtube_handle) {
        alert("Please provide at least one social media handle (Instagram, TikTok, or YouTube).");
        return;
      }
  ...
  const handleSubmit = () => {
    ...
    if (formData.content_types.includes("Other") && !formData.content_other.trim()) {
    ...
    if (formData.ai_tools.includes("Other") && !formData.ai_tools_other.trim()) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-rose-50 py-16 px-6 flex items-center justify-center">
        <Card className="max-w-2xl w-full p-12 bg-white border-2 border-black shadow-2xl rounded-none text-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-8">
            The first 200 Creator spots are filled. We're growing the Likelee ecosystem carefully so every AI Creator gets real visibility and paid opportunities. You're in the next cohort queue—we'll email you as soon as we open the gate.
          </p>
          ...
          <div className="space-y-4">
            <p className="text-lg font-semibold text-gray-900">Follow updates →</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                onClick={() => window.open('https://instagram.com/likelee', '_blank')}
                variant="outline"
              ...
              <Button
                onClick={() => window.location.href = 'mailto:hello@likelee.ai'}
                variant="outline"
                className="h-12 px-8 border-2 border-black rounded-none"
              >
                hello@likelee.ai
      ...
      <div className="max-w-3xl mx-auto">
        {step === 1 && (
          <Alert className="mb-8 bg-amber-50 border-2 border-amber-500 rounded-none">
            ...
            <AlertDescription className="text-amber-900 font-medium">
              <strong>Heads-up:</strong> The first 200 Creator spots are filled. We are onboarding in cohorts so every AI Creator gets an opportunity for visibility! Continue to sign up to lock-in your spot :)
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-gray-900">Join as Creator</h2>
        ...
        <Card className="p-8 bg-white border-2 border-black shadow-xl rounded-none">
          {step === 1 && (
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Basic Details</h3>
                <p className="text-gray-600">Let's start with your information</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t-2 border-gray-200">
                  <Label className="text-sm font-medium text-gray-700 mb-3 block">
                    Social Media Handles * <span className="text-sm text-gray-500 font-normal">(At least 1 required)</span>
                  </Label>
                  <div className="space-y-3">
                    <div>
                      <Label htmlFor="instagram_handle" className="text-sm text-gray-600 mb-2 block">
                        Instagram
                      </Label>
                      <Input
                        id="instagram_handle"
                    ...
                    <div>
                      <Label htmlFor="tiktok_handle" className="text-sm text-gray-600 mb-2 block">
                        TikTok
                      </Label>
                      <Input
                        id="tiktok_handle"
                    ...
                    <div>
                      <Label htmlFor="youtube_handle" className="text-sm text-gray-600 mb-2 block">
                        YouTube
                      </Label>
                      <Input
                        id="youtube_handle"
                ...
                <div className="pt-4 border-t-2 border-gray-200">
                  <Label htmlFor="agency_name" className="text-sm font-medium text-gray-700 mb-2 block">
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-2">If you're represented by an agency, enter their name here</p>
                </div>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Creator Profile Details</h3>
                <p className="text-gray-600">Tell us more about your creative work and experience.</p>
              </div>

              <div className="space-y-6 border-b pb-6 border-gray-200">
                <h4 className="text-xl font-bold text-gray-900">Creative Focus</h4>
                <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-96 overflow-y-auto pr-2">
                    {aiTools.map((tool) => (
                      <div key={tool} className="flex items-center space-x-2 p-3 border-2 border-gray-200 rounded-none hover:bg-gray-50">
                        <Checkbox
                          id={`ai-tool-${tool.replace(/\s+/g, '-')}`}
                          checked={formData.ai_tools.includes(tool)}
                          onCheckedChange={() => toggleArrayItem("ai_tools", tool)}
                          className="border-2 border-gray-400"
                        />
                        <label
              ...
              <div className="space-y-6 border-b pb-6 border-gray-200">
                <h4 className="text-xl font-bold text-gray-900">Location & Experience</h4>
                <div className="space-y-4">
              ...
              <div className="space-y-6 border-b pb-6 border-gray-200">
                <h4 className="text-xl font-bold text-gray-900">Portfolio & Social</h4>
                <p className="text-gray-600">Optional: Share your work and social presence</p>
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="portfolio_url" className="text-sm font-medium text-gray-700 mb-2 block">
                      Portfolio URL
                    </Label>
                    <Input
                      id="portfolio_url"
                  ...
                  <div>
                    <Label htmlFor="social_url" className="text-sm font-medium text-gray-700 mb-2 block">
                      Social Media URL
                    </Label>
                    <Input
                      id="social_url"
              ...
              <div className="space-y-6">
                <h4 className="text-xl font-bold text-gray-900">Upload Profile Photo</h4>
                <p className="text-gray-600">Add a professional photo to your profile</p>
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="profilePhotoInput" className="text-sm font-medium text-gray-700 mb-2 block">
              ...
              <div className="flex gap-4">
                ...
                >
                  {updateProfileMutation.isPending ? "Submitting..." : "Complete Sign Up"}
