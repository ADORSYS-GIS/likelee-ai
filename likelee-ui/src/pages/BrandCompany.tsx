    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-4xl mx-auto mb-8 leading-relaxed">
              Access a marketplace of verified creators and AI filmmakers. Post
              a project brief. Get deliverables back.{" "}
              <span className="font-bold text-gray-900">
                Clear scope, clear pricing, clear results.
              </span>{" "}
              No hourly rates. No surprise invoices.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              No more juggling agencies, getting surprised by invoices, or
              waiting weeks for creative assets.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-700 leading-relaxed text-lg">
                Real people who've licensed their likeness for commercial use.
                Portfolio-verified. Track record visible.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-700 leading-relaxed text-lg">
                Professional AI creators specializing in commercials, campaigns,
                trailers, and branded content. See their past work.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-700 leading-relaxed text-lg">
                Every project has defined deliverables, timeline, and price. No
                scope creep. No "wait, can we change this?"
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-700 leading-relaxed text-lg">
                You know exactly what you're paying before you post the brief.
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              You have options. Use Likelee directly, or bring in a partner.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="p-8 bg-gradient-to-br from-[#F7B750]/10 to-[#FAD54C]/10 border-2 border-black rounded-none">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Option 1: Direct Hiring (Self-Serve)
              </h3>
              <p className="text-gray-700 leading-relaxed text-lg">
                Browse verified creators and AI filmmakers. Post your brief.
                Manage projects yourself. Fast, transparent, full control.
              </p>
            </Card>

            <Card className="p-8 bg-white border-2 border-black rounded-none">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Option 2: Invite Your Marketing Agency
              </h3>
              <p className="text-gray-700 leading-relaxed text-lg">
                Have an agency already? Invite them to manage your Likelee
                projects. They handle talent selection, briefing, approvals. You
                stay in the loop. One platform for everything.
              </p>
            </Card>

            <Card className="p-8 bg-white border-2 border-black rounded-none">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Option 3: Use a Likelee Partner Agency
              </h3>
              <p className="text-gray-700 leading-relaxed text-lg">
                Prefer hands-off? Browse agencies on Likelee who specialize in
                your industry. They source talent, manage production, deliver
                results. You oversee and approve.
              </p>
            </Card>
          </div>
          ...
          <Card className="p-8 bg-gradient-to-r from-[#F7B750] to-[#FAD54C] border-2 border-black rounded-none text-center">
            <p className="text-xl text-white font-semibold">
              <span className="font-bold">The Likelee Difference:</span> Whether
              you hire directly or use an agency, all projects run on the same
              transparent platform. Same escrow payment protection. Same
              compliance. Same speed. No hidden markups.
            </p>
          </Card>
        </div>
      </section>
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Speed, Quality, Compliance. Plus Flexibility.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                Self-Serve or Agency-Managed
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Hire directly from the marketplace or delegate to an agency
                (yours or ours). Same transparent platform. Same pricing. Same
                compliance. You choose what works best.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-600 leading-relaxed">
                Post brief today, get deliverables in 3–5 days. Project scope
                clarity = faster execution. No back-and-forth on creative
                direction.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-600 leading-relaxed">
                Every creator and agency on Likelee has a portfolio and track
                record. You're not hiring blind. You see their past work before
                you book.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-600 leading-relaxed">
                Project-based pricing. Whether you hire direct or through an
                agency, you know exactly what you're paying. No per-slot
                surprises. No CPM confusion. No 30-day licensing markups.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-600 leading-relaxed">
                Every project comes with pre-built, SAG-AFTRA-aligned contracts.
                Usage rights, territory, duration—all clearly defined and
            ...
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-600 leading-relaxed">
                Watermarked assets. Automated DMCA protection. GDPR-compliant.
                You get verified creators with clear consent. No gray areas.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black transition-all hover:shadow-xl rounded-none bg-white">
              ...
              <p className="text-gray-600 leading-relaxed">
                Whether you're self-serving or working with an agency,
                everything runs on Likelee. Browse talent, submit briefs,
                approve deliverables, manage licenses—all in one place. Agencies
                stay organized. You stay in control.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="px-6 py-20 bg-white">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <Card className="p-6 border-2 border-black rounded-none bg-white">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Filter by creator type, niche, follower count, past work
                  quality, turnaround time. See portfolios before hiring.
                </p>
              </Card>
              ...
              <Card className="p-6 border-2 border-black rounded-none bg-white">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Define deliverables, scope, timeline, budget. Talent reviews
                  and quotes within 24 hours.
                </p>
              </Card>
              ...
              <Card className="p-6 border-2 border-black rounded-none bg-white">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Approve brief and talent. Payment goes into escrow (you're
                  protected). Creator starts work.
                </p>
              </Card>
              ...
              <Card className="p-6 border-2 border-black rounded-none bg-white">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-2">
                  Approve & Get Deliverables
                </h4>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Review for 48 hours. Approve and creator gets paid. Payment
          ...
          <div>
            <h3 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              Agency-Managed Path (Your Agency or Likelee Partner)
            </h3>
            <div className="grid md:grid-cols-5 gap-6">
              <Card className="p-6 border-2 border-black rounded-none bg-white">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Invite your marketing agency or browse Likelee Partner
                  Agencies.
                </p>
              </Card>
              ...
              <Card className="p-6 border-2 border-black rounded-none bg-white">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-2">
                  Agency Handles Sourcing
                </h4>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Agency searches talent, submits briefs, manages
                  communications.
                </p>
              </Card>
              ...
              <Card className="p-6 border-2 border-black rounded-none bg-white">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Review portfolios and brief before it goes out. Stay in the
                  loop.
                </p>
              </Card>
              ...
              <Card className="p-6 border-2 border-black rounded-none bg-white">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Payment goes into escrow. Creator only gets paid after you
              ...
              <Card className="p-6 border-2 border-black rounded-none bg-white">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Assets with full licensing and watermarks. Clean, verified
                  usage rights.
                </p>
              </Card>
            </div>
          ...
          <Card className="p-8 bg-gradient-to-r from-[#F7B750] to-[#FAD54C] border-2 border-black rounded-none text-center mt-12">
            <p className="text-xl text-white font-semibold">
              ...
              flexibility. Self-serve for speed and control. Agency-managed for
              hands-off strategy and expertise. Either way, Likelee keeps
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              We don't do hourly rates. We don't do CPM confusion. We do
              projects. And we protect your investment.
            </p>
          </div>
          ...
          <Card className="p-8 md:p-12 bg-white border-2 border-black shadow-xl rounded-none mb-12">
            ...
            <div className="space-y-3 text-lg text-gray-700">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-[#F7B750] flex-shrink-0 mt-1" />
                <p>
                  <span className="font-bold">Payment goes into escrow</span>{" "}
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-[#F7B750] flex-shrink-0 mt-1" />
                <p>
                  You review for 48 hours. If approved, creator gets paid
                  immediately. Payment auto-releases after 48 hours if no
                  dispute.
                </p>
              </div>
              <div className="flex items-start gap-3">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <Card className="p-8 border-2 border-black rounded-none bg-white">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Example Pricing (Verified Creators)
              </h3>
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b-2 border-black">
                      <th className="pb-3 pr-3 font-bold text-gray-900">
                        Project Type
                      </th>
                      <th className="pb-3 px-3 font-bold text-gray-900">
                        Budget
                      </th>
                      <th className="pb-3 pl-3 font-bold text-gray-900">
                        Turnaround
                      </th>
                    </tr>
                  </thead>
          ...
          <Card className="p-8 bg-gradient-to-r from-[#F7B750] to-[#FAD54C] border-2 border-black rounded-none text-center">
            <p className="text-xl text-white font-semibold">
              <span className="font-bold">Why This Matters:</span> You get the
              exact scope you pay for. No hourly surprises. No invoices that are
              30% higher than quoted. Clear budget planning.
            </p>
          </Card>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-8 border-2 border-black rounded-none bg-white">
              ...
              <p className="text-gray-700 leading-relaxed">
                Every deliverable includes cryptographic watermark tied to your
                license. Automatic verification if disputed.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black rounded-none bg-white">
              ...
              <p className="text-gray-700 leading-relaxed">
                If someone uses your asset without rights, Likelee's system
                flags it and issues DMCA takedowns automatically.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black rounded-none bg-white">
              ...
              <p className="text-gray-700 leading-relaxed">
                All creator agreements align with influencer-code guidelines.
                Your lawyers will approve.
              </p>
            </Card>
            ...
            <Card className="p-8 border-2 border-black rounded-none bg-white">
              ...
              <p className="text-gray-700 leading-relaxed">
                No PII passed around. Full data sovereignty. You get verified
                talent, no privacy concerns.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="px-6 py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 border-2 border-black rounded-none bg-white">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Campaign Example 1: Fashion Brand (Self-Serve)
              </h3>
              <div className="space-y-3 text-gray-700">
                <p>
                  <span className="font-bold">Need:</span> 5 Instagram Reels
                  featuring verified micro-influencers
                </p>
                <p>Brand posts brief on Likelee with $2K budget</p>
                <p>Selects 5 creators directly @ $400 each</p>
                <p>
                  <span className="font-bold">Payment:</span> $2K goes into
                  escrow upfront (you're protected)
                </p>
                <p>Creators deliver 5 reels</p>
                <p>
                  Brand reviews and approves within 48 hours → creators get paid
                </p>
                <p>
                  <span className="font-bold">Timeline:</span> 5 days
                </p>
                <p>
                  <span className="font-bold">Deliverables:</span> 5
                  high-quality reels, ready to post, all rights included
                </p>
                <p>
                  <span className="font-bold">Usage:</span> Instagram only, 30
                  days
                </p>
              </div>
            </Card>
            ...
            <Card className="p-8 border-2 border-black rounded-none bg-white">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Campaign Example 2: Tech Company (Agency-Managed)
              </h3>
              <div className="space-y-3 text-gray-700">
                <p>
                  <span className="font-bold">Need:</span> 30-second commercial
                  with athlete testimonial
                </p>
                ...
                <p>
                  <span className="font-bold">Payment:</span> $800 goes into
                  escrow (you're protected)
                </p>
                <p>Athlete delivers 30-second video</p>
                <p>Brand approves → athlete gets paid within 48 hours</p>
                <p>
                  <span className="font-bold">Timeline:</span> 3 days
                </p>
                <p>
                  <span className="font-bold">Deliverables:</span> 30-second 4K
                  video, watermarked, usage rights for broadcast + web
                </p>
                <p>
                  <span className="font-bold">Usage:</span> TV commercial,
                  social media, global, 90 days
                </p>
              </div>
            </Card>
          </div>
      ...
      <section className="px-6 py-24 bg-gradient-to-r from-[#F7B750] to-[#FAD54C]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-amber-100 mb-10">
            Browse verified talent. Post a brief. Get deliverables back. All in
            one platform. No middlemen. No surprise invoices.
          </p>
          <Button
            onClick={() =>
              navigate(
