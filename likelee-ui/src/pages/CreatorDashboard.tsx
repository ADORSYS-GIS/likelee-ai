...
const mockActiveCampaigns = [
  ...
  },
  {
    ...
    brand: "Tesla Motors",
    brand_logo:
      "https://images.unsplash.com/photo-1560958089-b8a1929cea89?w=100",
...
export default function CreatorDashboard() {
  ...
  const [creator, setCreator] = useState({
    ...
    profile_photo:
      "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/3ce34e58b_Screenshot2025-10-24at101047AM.png",
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="p-6 bg-white border border-gray-200">
          ...
          <Badge className="mt-2 bg-green-100 text-green-700 border border-green-300">
            All Running
          </Badge>
        </Card>
        ...
        <Card className="p-6 bg-white border border-gray-200">
          ...
          {pendingCount > 0 && (
            <Badge className="mt-2 bg-yellow-100 text-yellow-700 border border-yellow-300">
              Action Needed
            </Badge>
          )}
        </Card>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        >
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">
            Review {pendingCount} Usage Request{pendingCount !== 1 ? "s" : ""}
          </h3>
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-6">
        ...
        <Card className="p-6 bg-white border border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">
            From {activeCampaigns.length} campaigns
          </p>
        </Card>
        ...
        <Card className="p-6 bg-white border border-gray-200">
          ...
          <Badge className="mt-2 bg-blue-100 text-blue-700 border border-blue-300">
            Same as current
          </Badge>
        </Card>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="p-4 bg-white rounded-lg border border-gray-200">
            ...
            <p className="text-3xl font-bold text-[#32C8D1]">
              ${totalMonthlyRevenue}/month
            </p>
            <p className="text-sm text-gray-600">
              6 months = ${totalMonthlyRevenue * 6}
            </p>
          </div>
        </div>
      </Card>
          ...
          {[
            {
              ...
              amount: 2450,
              status: "paid",
              transaction: "TXN_112025",
            },
            {
              date: "2025-10-01",
              amount: 2200,
              status: "paid",
              transaction: "TXN_102025",
            },
            {
              date: "2025-09-01",
              amount: 1750,
              status: "paid",
              transaction: "TXN_092025",
            },
          ].map((payment, index) => (
            <div
              key={index}
