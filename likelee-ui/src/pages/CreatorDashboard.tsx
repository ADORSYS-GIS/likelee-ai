  ...
  const renderPublicProfilePreview = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        <Card className="overflow-hidden border-gray-200 bg-white shadow-sm w-full max-w-6xl">
          {/* Banner */}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex gap-3 items-start max-w-5xl">
          <AlertCircle className="h-5 w-5 text-blue-600 shrink-0 mt-0.5" />
          <p className="text-blue-900 text-sm">
