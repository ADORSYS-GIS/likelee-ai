    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-16 px-6">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">Support</h1>
          <p className="text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto mb-4">
            ...
            <a href="mailto:help@likelee.ai" className="text-[#32C8D1] hover:text-[#2AB8C1] font-semibold underline">
              help@likelee.ai
            </a>
            .
          </p>
          <p className="text-lg text-gray-600">
            We read every message. Please include as much detail as you can (screenshots, links, steps to reproduce). 
