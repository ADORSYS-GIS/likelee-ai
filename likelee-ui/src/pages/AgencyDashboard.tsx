...
import {
  ...
  MapPin, Instagram, Calendar, Globe, Plus, Edit, ArrowUpDown, X,
...
const mockRoster = [
  {
    id: 1,
    name: "Emma",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/5d413193e_Screenshot2025-10-29at63349PM.png",
    status: "active",
    consent: "complete",
    verified: true,
  ...
  },
  {
    id: 2,
    name: "Sergine",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/7b92ca646_Screenshot2025-10-29at63428PM.png",
    status: "active",
    consent: "complete",
    verified: true,
  ...
  },
  {
    id: 3,
    name: "Milan",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/b0ae64ffa_Screenshot2025-10-29at63451PM.png",
    status: "active",
    consent: "complete",
    verified: true,
  ...
  },
  {
    id: 4,
    name: "Julia",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/c5a5c61e4_Screenshot2025-10-29at63512PM.png",
    status: "active",
    consent: "expiring",
    verified: true,
  ...
  },
  {
    id: 5,
    name: "Matt",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/eb5550a53_Screenshot2025-10-29at63527PM.png",
    status: "active",
    consent: "complete",
    verified: true,
  ...
  },
  {
    id: 6,
    name: "Carla",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/cf591ec97_Screenshot2025-10-29at63544PM.png",
    status: "active",
    consent: "complete",
    verified: true,
  ...
  },
  {
    id: 7,
    name: "Luisa",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/dfe7c47ac_Screenshot2025-10-29at63612PM.png",
    status: "active",
    consent: "complete",
    verified: true,
  ...
  },
  {
    id: 8,
    name: "Clemence",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/ee3aae03f_Screenshot2025-10-29at63651PM.png",
    status: "active",
    consent: "complete",
    verified: true,
  ...
  },
  {
    id: 9,
    name: "Lina",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/ac71e274e_Screenshot2025-10-29at63715PM.png",
    status: "active",
    consent: "complete",
    verified: true,
  ...
  },
  {
    id: 10,
    name: "Aaron",
    headshot: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/86e331be1_Screenshot2025-10-29at63806PM.png",
    status: "pending",
    consent: "missing",
    verified: false,
...
export default function AgencyDashboard() {
  ...
  const activeCampaigns = new Set(mockRoster.filter(t => t.last_campaign !== '—').map(t => t.last_campaign)).size;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-3">
                <img src={mockAgency.logo} alt="Agency" className="w-10 h-10 object-contain" />
              ...
              <div className="hidden md:flex items-center gap-1">
                ...
                <Button variant={activeTab === "licensing" ? "default" : "ghost"} onClick={() => setActiveTab("licensing")} className="text-sm">Licensing</Button>
                <Button variant={activeTab === "usage" ? "default" : "ghost"} onClick={() => setActiveTab("usage")} className="text-sm">Protect & Usage</Button>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                ...
                {showNotifications && (
                  <div className="absolute right-0 mt-2 w-96 bg-white border-2 border-gray-200 shadow-xl z-50" onMouseEnter={() => setShowNotifications(true)} onMouseLeave={() => setShowNotifications(false)}>
                    ...
                    <div className="p-3 border-t border-gray-200 text-center">
                      <Button variant="ghost" className="text-sm text-indigo-600 hover:text-indigo-700">View all notifications</Button>
                    </div>
                  </div>
                )}
              </div>
                  ...
                  <div className="absolute right-0 mt-2 w-72 bg-white border-2 border-gray-200 shadow-xl z-50">
                    <div className="p-4 border-b border-gray-200">
                      <div className="flex items-center gap-3 mb-2">
                        <img src={mockAgency.logo} alt="Agency" className="w-12 h-12 object-contain" />
                        <div>
                    ...
                    <div className="p-2">
                      ...
                      <button className="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 text-left">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900">Team & Permissions</p>
                          <p className="text-xs text-gray-500">{mockAgency.seats_used} active users</p>
                        </div>
                      </button>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex gap-4 mb-6">
          <Alert className="flex-1 py-2 px-4 bg-blue-50 border border-blue-300 rounded-none">
            <AlertDescription className="text-blue-900 text-sm font-medium">
              <strong>Demo Mode:</strong> This is a preview of the Agency Dashboard for talent and modeling agencies.
            </AlertDescription>
          </Alert>
        </div>
            ...
            <Card className="p-6 bg-white border-2 border-gray-200">
              <div className="flex items-start justify-between mb-6">
                <div className="flex gap-6">
                  <img src={mockAgency.logo} alt={mockAgency.name} className="w-20 h-20 object-contain border-2 border-gray-200" />
                  <div>
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <Badge className={mockAgency.marketplace_visible ? 'bg-blue-500 text-white' : 'bg-gray-400 text-white'}>
                        Marketplace: {mockAgency.marketplace_visible ? 'Public' : 'Private'}
                      </Badge>
                    </div>
              ...
              <div className="grid md:grid-cols-3 gap-4 pt-6 border-t border-gray-200">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-700">Stripe Connected</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-green-600" />
                  <span className="text-sm text-gray-700">ElevenLabs Connected</span>
                </div>
                <div className="flex items-center gap-3 group relative cursor-pointer">
                  <Users className="w-5 h-5 text-gray-600" />
                  <span className="text-sm text-gray-700">
                    {mockAgency.seats_used} / {mockAgency.seats_total} seats used
                  </span>
                  <div className="absolute left-0 top-full mt-2 bg-gray-900 text-white text-xs px-3 py-2 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
                    Add more seats (you have {mockAgency.seats_total - mockAgency.seats_used} left)
                  </div>
                </div>
              </div>
            </Card>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <Card className="p-6 bg-white border-2 border-gray-300 rounded-none">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600 mb-1 font-medium">Active Talent</p>
                    <p className="text-4xl font-bold text-gray-900">{activeTalent}</p>
                    <p className="text-xs text-gray-500 mt-1">of {mockRoster.length} total</p>
                  </div>
              ...
              <Card className="p-6 bg-white border-2 border-gray-300 rounded-none">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600 mb-1 font-medium">Monthly Earnings</p>
              ...
              <Card className="p-6 bg-white border-2 border-gray-300 rounded-none">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-600 mb-1 font-medium">Expiring Licenses</p>
                    <p className="text-4xl font-bold text-gray-900">{expiringLicenses}</p>
              ...
              <Tabs value={rosterTab} onValueChange={setRosterTab}>
                <div className="flex items-center justify-between mb-6">
                  <TabsList>
                    ...
                    <TabsTrigger value="analytics">
                      Analytics
                      <Badge className="ml-2 bg-indigo-600 text-white text-xs">Pro</Badge>
                    </TabsTrigger>
                  </TabsList>
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button onClick={() => navigate(createPageUrl("AddTalent"))} className="bg-indigo-600 hover:bg-indigo-700 text-white">
                ...
                <TabsContent value="roster" className="mt-0">
                  <div className="flex flex-wrap gap-4 mb-6 pb-6 border-b border-gray-200">
                    <div className="flex-1 min-w-[200px]">
                      <Input placeholder="Search talent..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="border-2 border-gray-300" />
                    </div>
                    ...
                    {(searchQuery || statusFilter !== "all" || consentFilter !== "all") && (
                      <Button variant="ghost" onClick={() => { setSearchQuery(""); setStatusFilter("all"); setConsentFilter("all"); }} className="text-gray-600">
                    ...
                    <table className="w-full">
                      <thead className="bg-gray-50 border-b border-gray-200">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-left">
                            <button onClick={() => handleSort("status")} className="flex items-center gap-2 text-xs font-semibold text-gray-700 uppercase hover:text-gray-900">
                              Status
                              <ArrowUpDown className="w-3 h-3" />
                            </button>
                          </th>
                          ...
                          <th className="px-4 py-3 text-left">
                            <button onClick={() => handleSort("instagram_followers")} className="flex items-center gap-2 text-xs font-semibold text-gray-700 uppercase hover:text-gray-900">
                              Followers
                              <ArrowUpDown className="w-3 h-3" />
                            </button>
                          </th>
                          <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Assets</th>
                          <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Top Brand</th>
                          ...
                          <th className="px-4 py-3 text-left">
                            <button onClick={() => handleSort("projected_earnings")} className="flex items-center gap-2 text-xs font-semibold text-gray-700 uppercase hover:text-gray-900">
                              Projected
                              <ArrowUpDown className="w-3 h-3" />
                            </button>
                          </th>
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {filteredRoster.map((talent) => (
                          <tr key={talent.id} onClick={() => setSelectedTalent(talent)} className="hover:bg-gray-50 cursor-pointer transition-colors">
                            <td className="px-4 py-4">
                              <div className="flex items-center gap-3">
                                <img src={talent.headshot} alt={talent.name} className="w-12 h-12 object-cover border-2 border-gray-200" />
                                <div>
                                  <div className="flex items-center gap-2">
                                    <span className="font-medium text-gray-900">{talent.name}</span>
                                    {talent.verified && <CheckCircle2 className="w-4 h-4 text-green-600" />}
                                  </div>
                                  <span className="text-xs text-gray-500">{talent.categories.join(', ')}</span>
                                </div>
                              </div>
                            </td>
                            <td className="px-4 py-4">
                              <Badge className={talent.status === 'active' ? 'bg-green-100 text-green-800' : talent.status === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800'}>
                                {talent.status}
                              </Badge>
                            </td>
                            <td className="px-4 py-4">
                              <Badge className={talent.consent === 'complete' ? 'bg-green-100 text-green-800' : talent.consent === 'expiring' ? 'bg-orange-100 text-orange-800' : 'bg-red-100 text-red-800'}>
                                {talent.consent === 'expiring' ? <Clock className="w-3 h-3 mr-1" /> : talent.consent === 'missing' ? <XCircle className="w-3 h-3 mr-1" /> : <CheckCircle2 className="w-3 h-3 mr-1" />}
                                {talent.consent}
                              </Badge>
                            </td>
                            <td className="px-4 py-4">
                            ...
                            <td className="px-4 py-4 text-sm text-gray-700">{talent.assets_count}</td>
                            <td className="px-4 py-4 text-sm text-gray-700">{talent.top_brand}</td>
                            <td className="px-4 py-4">
                              <div className="flex items-center gap-2">
                                <span className={`text-sm ${isLicenseExpired(talent.license_expiry) ? 'text-red-600 font-medium' : isLicenseExpiring(talent.license_expiry) ? 'text-orange-600 font-medium' : 'text-gray-700'}`}>
                                  {talent.license_expiry !== '—' ? new Date(talent.license_expiry).toLocaleDateString() : '—'}
                                </span>
                                {isLicenseExpiring(talent.license_expiry) && <Clock className="w-4 h-4 text-orange-500" />}
                                {isLicenseExpired(talent.license_expiry) && <XCircle className="w-4 h-4 text-red-500" />}
                              </div>
                            </td>
                            <td className="px-4 py-4 text-sm font-medium text-gray-900">${talent.earnings_30d.toLocaleString()}</td>
                            <td className="px-4 py-4 text-sm text-gray-700">${talent.projected_earnings.toLocaleString()}</td>
                            <td className="px-4 py-4">
                ...
                <TabsContent value="campaigns">
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 text-lg">Campaign tracking coming soon</p>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="licenses">
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 text-lg">License management coming soon</p>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="analytics">
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 text-lg mb-2">Advanced Analytics</p>
                    <p className="text-gray-400 text-sm mb-6">Upgrade to Agency Pro to unlock revenue forecasting, performance charts, and insights.</p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-6">
              {mockLicensingRequests.map((request) => (
                <Card key={request.id} className="p-6 bg-white border-2 border-black rounded-none hover:shadow-lg transition-shadow">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 mb-2">{request.brand}</h3>
                      <p className="text-lg text-gray-700 mb-3">{request.campaign}</p>
                      <div className="flex flex-wrap gap-2 mb-3">
                        {request.talent.map((name) => (
                          <Badge key={name} className="bg-indigo-100 text-indigo-800">{name}</Badge>
                        ))}
                      </div>
                    </div>
                    <Badge className={request.status === 'reviewing' ? 'bg-blue-100 text-blue-800' : request.status === 'negotiating' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800'}>
                      {request.status}
                    </Badge>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-6">
                    <div>
                      ...
                      <p className="text-base font-medium text-gray-900">{request.budget}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600 mb-1">Usage Scope</p>
                      <p className="text-base font-medium text-gray-900">{request.scope}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600 mb-1">Regions</p>
                      <p className="text-base font-medium text-gray-900">{request.regions.join(', ')}</p>
                    </div>
                    <div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button variant="outline" className="flex-1 border-2 border-gray-300">Counter Offer</Button>
        ...
        {activeTab === "usage" && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900">Protect & Usage Tracking</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="p-6 bg-white border-2 border-gray-200">
                <p className="text-sm text-gray-600 mb-2">Total Detections (30d)</p>
            ...
            <Card className="p-6 bg-white border-2 border-gray-200">
              <p className="text-center text-gray-500 py-12">Usage tracking data will appear here once campaigns are live</p>
            </Card>
          </div>
        )}
        ...
        {activeTab === "royalties" && (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold text-gray-900">Royalties & Payouts</h2>
              <Button variant="outline" className="border-2 border-gray-300">
                <Download className="w-4 h-4 mr-2" />
                Export Report
              </Button>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="p-6 bg-white border-2 border-gray-200">
                <p className="text-sm text-gray-600 mb-2">Accrued This Month</p>
            ...
            <Card className="p-6 bg-white border-2 border-gray-200">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Top Earning Talent</h3>
              <div className="space-y-3">
                {mockRoster.filter(t => t.earnings_30d > 0).map((talent) => (
                  <div key={talent.id} className="flex items-center justify-between p-3 bg-gray-50 border border-gray-200">
                    <div className="flex items-center gap-3">
                      <img src={talent.headshot} alt={talent.name} className="w-10 h-10 rounded-full object-cover" />
                      <span className="font-medium text-gray-900">{talent.name}</span>
                    </div>
                    <span className="text-lg font-bold text-gray-900">${talent.earnings_30d.toLocaleString()}</span>
                  </div>
                ))}
              </div>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Tabs value={analyticsTab} onValueChange={setAnalyticsTab}>
              ...
              <TabsContent value="overview" className="space-y-6 mt-6">
                <div className="grid md:grid-cols-4 gap-6">
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    ...
                    <p className="text-sm text-gray-600 mb-1">Total Earnings (30d)</p>
                  ...
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    ...
                    <p className="text-xs text-blue-600 mt-2">Across {activeTalent} talent</p>
                  </Card>
                  ...
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    ...
                    <p className="text-sm text-gray-600 mb-1">AI Usages (30d)</p>
                    <p className="text-3xl font-bold text-gray-900">73</p>
                    <p className="text-xs text-purple-600 mt-2">+18% vs last period</p>
                  </Card>
                  ...
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    ...
                    <p className="text-sm text-gray-600 mb-1">Avg Campaign Value</p>
                    <p className="text-3xl font-bold text-gray-900">$1,796</p>
                    <p className="text-xs text-orange-600 mt-2">{expiringLicenses} expiring soon</p>
                  </Card>
                </div>

                <Card className="p-6 bg-white border-2 border-black rounded-none">
                  <h3 className="text-lg font-bold text-gray-900 mb-6">Monthly Performance Trends</h3>
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={monthlyTrendsData}>
                      ...
                      <Line type="monotone" dataKey="campaigns" stroke="#3b82f6" strokeWidth={3} name="Campaigns" />
                      <Line type="monotone" dataKey="usages" stroke="#8b5cf6" strokeWidth={3} name="AI Usages" />
                    </LineChart>
                  </ResponsiveContainer>
                </Card>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <h3 className="text-lg font-bold text-gray-900 mb-6">AI Usage Type Distribution</h3>
                  ...
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <h3 className="text-lg font-bold text-gray-900 mb-6">Consent Status Breakdown</h3>
                    <ResponsiveContainer width="100%" height={250}>
                      <RechartsPieChart>
                        <Pie
              ...
              <TabsContent value="roster" className="space-y-6 mt-6">
                <Card className="p-6 bg-white border-2 border-black rounded-none">
                  <h3 className="text-lg font-bold text-gray-900 mb-6">Earnings by Talent (Last 30 Days)</h3>
                  <ResponsiveContainer width="100%" height={400}>
                    <BarChart data={talentEarningsData}>
                      ...
                      />
                      <Legend />
                      <Bar dataKey="earnings" fill="#10b981" name="30D Earnings ($)" />
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <h4 className="font-bold text-gray-900 mb-4">Top Performer (Earnings)</h4>
                    <div className="flex items-center gap-3 mb-3">
                      <img src={mockRoster[5].headshot} alt="Carla" className="w-16 h-16 object-cover border-2 border-black" />
                      <div>
                        <p className="font-bold text-xl text-gray-900">Carla</p>
                        <p className="text-2xl font-bold text-green-600">${mockRoster[5].earnings_30d.toLocaleString()}</p>
                      </div>
                    </div>
                    <p className="text-sm text-gray-600">{mockRoster[5].usage_30d} campaigns • {mockRoster[5].engagement_rate}% engagement</p>
                  </Card>

                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <h4 className="font-bold text-gray-900 mb-4">Most Active (Campaigns)</h4>
                    <div className="flex items-center gap-3 mb-3">
                      <img src={mockRoster[3].headshot} alt="Julia" className="w-16 h-16 object-cover border-2 border-black" />
                      <div>
                        <p className="font-bold text-xl text-gray-900">Julia</p>
                        <p className="text-2xl font-bold text-blue-600">{mockRoster[3].usage_30d} uses</p>
                      </div>
                    </div>
                    <p className="text-sm text-gray-600">${mockRoster[3].earnings_30d.toLocaleString()} earnings • {mockRoster[3].engagement_rate}% engagement</p>
                  </Card>

                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <h4 className="font-bold text-gray-900 mb-4">Highest Engagement</h4>
                    <div className="flex items-center gap-3 mb-3">
                      <img src={mockRoster[5].headshot} alt="Carla" className="w-16 h-16 object-cover border-2 border-black" />
                      <div>
                        <p className="font-bold text-xl text-gray-900">Carla</p>
                        <p className="text-2xl font-bold text-purple-600">{mockRoster[5].engagement_rate}%</p>
                      </div>
                    </div>
                    <p className="text-sm text-gray-600">{mockRoster[5].instagram_followers.toLocaleString()} followers • {mockRoster[5].usage_30d} campaigns</p>
                  </Card>
                </div>

                <Card className="p-6 bg-white border-2 border-black rounded-none">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">Talent Performance Metrics</h3>
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead className="bg-gray-50 border-b-2 border-gray-200">
                        <tr>
                          <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Talent</th>
                          <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">30D Earnings</th>
                          <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Campaigns</th>
                          <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Avg Value</th>
                        ...
                        {mockRoster.filter(t => t.earnings_30d > 0).map((talent) => (
                          <tr key={talent.id} className="hover:bg-gray-50">
                            <td className="px-4 py-3">
                              <div className="flex items-center gap-2">
                                <img src={talent.headshot} alt={talent.name} className="w-8 h-8 object-cover" />
                                <span className="font-medium text-gray-900">{talent.name}</span>
                              </div>
                            </td>
                            <td className="px-4 py-3 font-bold text-gray-900">${talent.earnings_30d.toLocaleString()}</td>
                            <td className="px-4 py-3 text-gray-700">{talent.usage_30d}</td>
                            <td className="px-4 py-3 text-gray-700">${Math.round(talent.earnings_30d / talent.usage_30d).toLocaleString()}</td>
                            <td className="px-4 py-3 text-gray-700">{talent.engagement_rate}%</td>
                            <td className="px-4 py-3">
              ...
              <TabsContent value="clients" className="space-y-6 mt-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <h3 className="text-lg font-bold text-gray-900 mb-6">Earnings by Client</h3>
                    <ResponsiveContainer width="100%" height={300}>
                      <RechartsPieChart>
                        <Pie
                ...
                <Card className="p-6 bg-white border-2 border-black rounded-none">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">Top Clients Performance</h3>
                  <div className="space-y-4">
                    {clientEarningsData.slice(0, 5).map((client, idx) => (
                      <div key={idx} className="flex items-center justify-between p-4 bg-gray-50 border-2 border-gray-200 rounded-none">
                        <div>
                          <p className="font-bold text-gray-900">{client.name}</p>
                          <p className="text-sm text-gray-600">{client.campaigns} campaigns</p>
                        </div>
                        <div className="text-right">
                          <p className="text-xl font-bold text-green-600">${client.value.toLocaleString()}</p>
                          <p className="text-xs text-gray-500">{((client.value / totalEarnings) * 100).toFixed(1)}% of total</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <p className="text-sm text-gray-600 mb-2">Repeat Client Rate</p>
                    <p className="text-4xl font-bold text-gray-900">78%</p>
                    <Progress value={78} className="mt-3 h-2" />
                  </Card>

                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <p className="text-sm text-gray-600 mb-2">Avg Campaign Duration</p>
                    <p className="text-4xl font-bold text-gray-900">18 days</p>
                    <p className="text-xs text-gray-500 mt-2">From booking to completion</p>
                  </Card>

                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <p className="text-sm text-gray-600 mb-2">Client Acquisition</p>
                    <p className="text-4xl font-bold text-gray-900">4</p>
                    <p className="text-xs text-green-600 mt-2">New clients this quarter</p>
                  </Card>
                </div>
              </TabsContent>
              ...
              <TabsContent value="compliance" className="space-y-6 mt-6">
                <div className="grid md:grid-cols-3 gap-6">
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    ...
                    <p className="text-xs text-gray-500 mt-2">All talent verified</p>
                  </Card>
                  ...
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    ...
                    <p className="text-xs text-gray-500 mt-2">8 of 10 complete</p>
                  </Card>
                  ...
                  <Card className="p-6 bg-white border-2 border-black rounded-none">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-3xl font-bold text-gray-900">{expiringLicenses}</p>
                      </div>
                    </div>
                ...
                <Card className="p-6 bg-white border-2 border-black rounded-none">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">License Expiry Pipeline</h3>
                  <div className="space-y-3">
                    {mockRoster.filter(t => t.consent === 'expiring').map((talent) => (
                      <div key={talent.id} className="flex items-center justify-between p-4 bg-orange-50 border-2 border-orange-200 rounded-none">
                        <div className="flex items-center gap-3">
                          <img src={talent.headshot} alt={talent.name} className="w-10 h-10 object-cover" />
                          <div>
                            <p className="font-bold text-gray-900">{talent.name}</p>
                            <p className="text-sm text-gray-600">License expires {new Date(talent.license_expiry).toLocaleDateString()}</p>
                          </div>
                        </div>
                ...
                <Card className="p-6 bg-white border-2 border-black rounded-none">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <p className="text-sm text-gray-600 mb-3">Consent Status Distribution</p>
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center mt-3">
                          <span className="text-sm text-gray-700">Expiring</span>
                          <span className="font-bold text-orange-600">1 (10%)</span>
                        </div>
                        <Progress value={10} className="h-2 bg-orange-200" />
                        
                        <div className="flex justify-between items-center mt-3">
                          <span className="text-sm text-gray-700">Missing</span>
                          <span className="font-bold text-red-600">1 (10%)</span>
                        </div>
                    ...
                    <div>
                      <p className="text-sm text-gray-600 mb-3">Likeness Protection</p>
                      <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200">
                          <span className="text-sm text-gray-700">Authorized Uses (30d)</span>
                        ...
                        <div className="flex items-center justify-between p-3 bg-red-50 border border-red-200">
                          <span className="text-sm text-gray-700">Unauthorized Alerts</span>
                          <span className="font-bold text-red-600">0</span>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-blue-50 border border-blue-200">
                          <span className="text-sm text-gray-700">Disputes Resolved</span>
            ...
            <Card className="p-6 bg-white border-2 border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input value={mockAgency.location} className="border-2 border-gray-300" />
                </div>
              </div>
            </Card>
            <Card className="p-6 bg-white border-2 border-gray-200">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Payouts & invoicing</p>
                    </div>
                  </div>
      ...
      {selectedTalent && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-end" onClick={() => setSelectedTalent(null)}>
          <div className="bg-white h-full w-full md:w-[600px] shadow-2xl overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between z-10">
              <h2 className="text-2xl font-bold text-gray-900">Talent Details</h2>
              <Button variant="ghost" size="icon" onClick={() => setSelectedTalent(null)}>
                <X className="w-5 h-5" />
              </Button>
            </div>
            ...
            <div className="p-6 space-y-6">
              <div className="flex gap-6">
                <img src={selectedTalent.headshot} alt={selectedTalent.name} className="w-32 h-32 object-cover border-2 border-gray-200" />
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="text-2xl font-bold text-gray-900">{selectedTalent.name}</h3>
                    {selectedTalent.verified && <CheckCircle2 className="w-5 h-5 text-green-600" />}
                  </div>
                  <div className="flex flex-wrap gap-2 mb-3">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Card className="p-4 bg-gray-50">
                  <p className="text-xs text-gray-600 mb-1">Instagram Followers</p>
                  <p className="text-2xl font-bold text-gray-900">{selectedTalent.instagram_followers.toLocaleString()}</p>
                </Card>
                <Card className="p-4 bg-gray-50">
                  <p className="text-xs text-gray-600 mb-1">Engagement Rate</p>
                  <p className="text-2xl font-bold text-gray-900">{selectedTalent.engagement_rate}%</p>
                </Card>
                <Card className="p-4 bg-gray-50">
                  <p className="text-xs text-gray-600 mb-1">Total Assets</p>
                  <p className="text-2xl font-bold text-gray-900">{selectedTalent.assets_count}</p>
                </Card>
                <Card className="p-4 bg-gray-50">
                  <p className="text-xs text-gray-600 mb-1">30D Earnings</p>
                  <p className="text-2xl font-bold text-gray-900">${selectedTalent.earnings_30d.toLocaleString()}</p>
                </Card>
              </div>
              ...
              <Card className="p-4 bg-gradient-to-br from-indigo-50 to-blue-50 border-2 border-indigo-200">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <Badge className={selectedTalent.consent === 'complete' ? 'bg-green-100 text-green-800' : selectedTalent.consent === 'expiring' ? 'bg-orange-100 text-orange-800' : 'bg-red-100 text-red-800'}>
                      {selectedTalent.consent}
                    </Badge>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Expiry Date:</span>
                    <span className={`font-medium ${isLicenseExpiring(selectedTalent.license_expiry) ? 'text-orange-600' : 'text-gray-900'}`}>
                      {selectedTalent.license_expiry !== '—' ? new Date(selectedTalent.license_expiry).toLocaleDateString() : '—'}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
