      ...
      if (row) {
        ...
        if (
          ...
          toast({
            ...
            description: "Identity verified! Please upload your 3 reference photos (Front, Left, Right) to complete your setup.",
          });
        }
      }
      return row;
  ...
  const startLiveness = async () => {
    try {
      ...
      if (livenessStatus === "approved") {
        toast({
          title: "Info",
          description: "Liveness is already approved. No further checks needed.",
        });
        return;
      }
      if (!COGNITO_IDENTITY_POOL_ID) {
        toast({
          variant: "destructive",
          title: "Configuration Error",
          description: "Missing VITE_COGNITO_IDENTITY_POOL_ID in UI environment.",
        });
        return;
      }
                            ...
                            if (r.ok) {
                              ...
                              if (!data.passed) {
                                toast({
                                  ...
                                  description: "Liveness check failed. Please try again with good lighting and follow prompts.",
                                });
                              }
                              setTimeout(() => {
