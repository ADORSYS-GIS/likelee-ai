...
const creators = [
  ...
  },
  {
    ...
    approvalRate: "99%",
    image:
      "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/aafddf154_Screenshot2025-10-13at95036PM.png",
  },
  {
    name: "Sam Taylor",
    ...
    approvalRate: "97%",
    image:
      "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68ed7158e33f31b30f653449/cbebd9e9f_Screenshot2025-10-13at94948PM.png",
  },
];
...
export default function AICreators() {
  ...
  useEffect(() => {
    ...
    const structuredData = {
      ...
      description:
        "AI filmmakers earning $500-$5K per project. Portfolio + Projects + Payment. Studios find you. Clear scope. Payment protected in escrow.",
      ...
      <section className="relative px-6 pt-20 pb-16 overflow-hidden bg-white">
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-base md:text-lg lg:text-xl text-gray-700 max-w-4xl mx-auto mb-10 leading-relaxed">
            Portfolio + Projects + Payment. Studios and brands find you. Clear
            project scope.{" "}
            <span className="font-bold text-gray-900">
              Payment protected in escrow—you get paid when work is done.
            </span>{" "}
            Keep 80–90% of every project fee. Likelee connects verified AI
            filmmakers with studios actively seeking quality work.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
              Post your portfolio. Set your rates per project. Studios find you
              based on your work, not your willingness to negotiate down.
            </p>
          </div>
          ...
          <Card className="p-8 md:p-12 bg-white border-2 border-black shadow-xl rounded-none mb-12">
            ...
            <div className="space-y-4 text-lg text-gray-700">
              <div className="flex items-start gap-3">
                ...
                <p>
                  Studios search by style, tools, turnaround time, experience
                  level
                </p>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-[#F18B6A] flex-shrink-0 mt-1" />
                <p>
                  <span className="font-bold">Clear scope, clear payment:</span>{" "}
                  Studio pays into escrow, you get paid when work is done
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-[#F18B6A] flex-shrink-0 mt-1" />
                <p>
                  Get booked based on portfolio quality and delivery track
                  record
                </p>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="font-bold text-gray-900">
                  You keep 80–90% of every project fee
                </p>
              </div>
            </div>
          </Card>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Likelee connects studios with creators through clear,
              objective-based projects. You know exactly what you're delivering
              and what you're getting paid—before you start. Payment is
              protected.
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              <Card className="p-8 bg-gray-50 border-2 border-black rounded-none">
                ...
                <p className="text-gray-700 leading-relaxed">
                  No screenshots, no surveillance, no "proof of work"
                </p>
              </Card>
              ...
              <Card className="p-8 bg-gray-50 border-2 border-black rounded-none">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Studios define deliverables upfront
                </p>
              </Card>
              ...
              <Card className="p-8 bg-gray-50 border-2 border-black rounded-none">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Studio pays into escrow, you get paid when work is done (or
                  auto-releases after 48 hours)
                </p>
              </Card>
              ...
              <Card className="p-8 bg-gray-50 border-2 border-black rounded-none">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Studios choose based on your past work, not bids
                </p>
              </Card>
              ...
              <Card className="p-8 bg-gray-50 border-2 border-black rounded-none">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Get paid within 3 days of approval
                </p>
              </Card>
              ...
              <Card className="p-8 bg-gray-50 border-2 border-black rounded-none">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Studios re-book reliable creators (less hunting, more steady
                  work)
                </p>
              </Card>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            ...
            >
              ...
              <ChevronDown
                className={`w-5 h-5 ml-2 transition-transform ${showEarnings ? "rotate-180" : ""}`}
              />
            </Button>
          </div>
            ...
            <div className="space-y-12 animate-in fade-in duration-300">
              <div className="text-center">
                <p className="text-xl text-gray-600 mb-4">
                  Real Projects. Real Earnings. Payment Protected.
                </p>
                <p className="text-lg text-gray-700">
                  You set your rates per project. Studios pay the full amount
                  into escrow (protected). You deliver the work. You get paid
                  when it's done or automatically after 48 hours. You keep
                  80–90% of the total project fee.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="p-8 bg-white border-2 border-black rounded-none">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p className="text-lg">
                      <span className="font-bold">2–3 projects per month</span>{" "}
                      at $500–$1K per project
                    </p>
                    <p>
                      Quick turnarounds: 15–30 second commercials, social clips,
                      reels
                    </p>
                    <p className="text-sm text-gray-600">
                      Payment: Full amount escrowed, you get paid on approval
                    </p>
                    <p className="font-bold text-[#F18B6A]">
                      You earn: $400–$900 per project (after Likelee's 10%)
                    </p>
                    <p className="text-xl font-bold text-gray-900 pt-4">
                      Total monthly: $800–$2.7K
                    </p>
                  </div>
                </Card>
                ...
                <Card className="p-8 bg-gradient-to-br from-[#F18B6A]/10 to-[#E07A5A]/10 border-2 border-black rounded-none">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p className="text-lg">
                      <span className="font-bold">3–6 projects per month</span>{" "}
                      at $1K–$2.5K per project
                    </p>
                    ...
                    <p className="font-bold text-[#F18B6A]">
                      You earn: $800–$2.25K per project
                    </p>
                    <p className="text-xl font-bold text-gray-900 pt-4">
                      Total monthly: $2.4K–$13.5K
                    </p>
                  </div>
                </Card>
                ...
                <Card className="p-8 bg-white border-2 border-black rounded-none">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p className="text-lg">
                      <span className="font-bold">4–8 projects per month</span>{" "}
                      at $2K–$5K per project
                    </p>
                    <p>
                      Trailers, documentaries, branded films, complex projects
                    </p>
                    <p className="text-sm text-gray-600">
                      Payment: Full amount escrowed, you get paid on approval
                    </p>
                    ...
                    <p className="font-bold text-[#F18B6A]">
                      You earn: $1.6K–$4.5K per project
                    </p>
                    <p className="text-xl font-bold text-gray-900 pt-4">
                      Total monthly: $6.4K–$36K+
                    </p>
                  </div>
                </Card>
              </div>
                  ...
                  <table className="w-full text-left">
                    ...
                    <tbody>
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="py-4 px-4 font-bold text-[#F18B6A]">
                          $400–$720
                        </td>
              ...
              <Card className="p-8 bg-gradient-to-r from-[#F18B6A] to-[#E07A5A] border-2 border-black rounded-none text-center">
                <p className="text-lg text-white mb-4">
                  <span className="font-bold">Why This Matters:</span> You get
                  paid when work is done (or automatically after 48 hours). No
                  waiting for invoicing. No payment disputes dragging on.
                  Studios are committed because their money is in escrow.
                </p>
              </Card>
            </div>
          )}
            ...
            <table className="w-full text-sm border-2 border-black">
              <thead>
                <tr className="bg-gray-100 border-b-2 border-black">
                  ...
                  <th className="p-4 text-left font-bold text-[#F18B6A]">
                    Likelee
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-b border-gray-200 bg-gray-50">
                  ...
                  <td className="p-4 font-semibold text-[#F18B6A]">
                    Project-based, escrow-protected
                  </td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="p-4 font-semibold text-gray-900">
                ...
                <tr className="border-b border-gray-200 bg-gray-50">
                  ...
                  <td className="p-4 text-gray-700">
                    Rare (reorder every time)
                  </td>
                  <td className="p-4 text-gray-700">Possible</td>
                  <td className="p-4 font-semibold text-[#F18B6A]">
                    Built-in (studios re-book)
                  </td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="p-4 font-semibold text-gray-900">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div>
                ...
                <p className="text-sm text-gray-700">
                  Constant bidding, time tracking, low rates, payment disputes
                </p>
              </div>
              <div>
                <h4 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                ...
                <p className="text-sm text-gray-700">
                  Gigs commoditized, 20% cut, no repeat clients
                </p>
              </div>
              <div>
                <h4 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                ...
                <p className="text-sm text-gray-700">
                  Networking required, slow payments, limited opportunities
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-700">
                  Studios find you, project-based rates, escrow protection, fast
                  payments, repeat bookings
                </p>
              </div>
            </div>
          </Card>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-600">
              Discover the talented creators already building their careers on
              Likelee.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {creators.map((creator, index) => (
              <Card
                key={index}
                className="p-6 bg-white hover:shadow-2xl transition-all hover:-translate-y-2 border-2 border-black rounded-none"
              >
                <img
                  src={creator.image}
                  alt={creator.name}
                ...
                <p className="text-base md:text-lg text-[#F18B6A] font-medium mb-3">
                  {creator.specialty}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {creator.tools.map((tool, i) => (
                    <Badge
                      key={i}
                      className="bg-orange-100 text-orange-700 text-xs px-2 py-1 border-2 border-black rounded-none"
                    >
                      {tool}
                    </Badge>
                  ))}
                ...
                <div className="space-y-2 text-sm text-gray-700 mb-4">
                  <p>
                    <span className="font-bold">
                      {creator.projects} projects delivered
                    </span>
                  </p>
                  <p className="text-[#F18B6A] font-bold">
                    {creator.monthlyEarnings} earned this month (
                    {creator.projectsThisMonth})
                  </p>
                  <p>
                    Avg. turnaround:{" "}
                    <span className="font-semibold">{creator.turnaround}</span>
                  </p>
                  <p>
                    Approval rate:{" "}
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    variant="outline"
                    className="flex-1 border-2 border-black rounded-none text-sm"
                  >
                    Hire
                  </Button>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center border-2 border-black p-8 bg-gray-50">
              ...
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Upload your best work. Include projects you've completed, tools
                you use, and your typical turnaround time. No time tracking
                needed.
              </p>
            </div>
            ...
            <div className="text-center border-2 border-black p-8 bg-gray-50">
              ...
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                You decide what to charge per project. $500 for quick
                commercials, $2K for campaigns, $5K for larger work.
            ...
            <div className="text-center border-2 border-black p-8 bg-gray-50">
              ...
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Studios search by style, tools, experience, and turnaround time.
                Your portfolio shows up when it matches what they need.
              </p>
            </div>
            ...
            <div className="text-center border-2 border-black p-8 bg-gray-50">
              ...
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                Studio approves the brief. Full payment goes into escrow
                (protected). You deliver the work. You get paid when done or
                automatically after 48 hours. You keep 80–90%.
              </p>
            </div>
          </div>
        </div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 text-base text-gray-700 leading-relaxed">
                AI Artists are AI filmmakers who create video content using
                tools like Sora, Runway, Pika, Google Veo, and more. You set
                project-based rates, studios find your work, and you get booked
                for defined projects with clear scopes.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 text-base text-gray-700 leading-relaxed">
                No. Likelee is project-based only. You quote per project, not
                per hour. No time tracking. No surveillance. Clear scope, clear
                payment.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 text-base text-gray-700 leading-relaxed">
                Studio pays the full project amount into escrow (protected). You
                deliver the work. You get paid when it's done, or automatically
                after 48 hours if no dispute. You keep 80–90%. Payment processes
                within 3 days.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 text-base text-gray-700 leading-relaxed">
                You choose project-based rates. A 30-second commercial might be
                $500. A campaign could be $2K–$5K. You decide what's fair for
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 text-base text-gray-700 leading-relaxed">
                Commercials, brand campaigns, social content, short films,
                trailers, music videos, explainer videos—anything you can create
                with AI tools.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 text-base text-gray-700 leading-relaxed">
                Yes. You need access to tools like Sora, Runway, Pika, Google
                Veo, etc. Likelee doesn't provide tools—just the marketplace to
                sell your work.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 text-base text-gray-700 leading-relaxed">
                Yes. Revisions are handled project-to-project based on what's
                agreed upfront. Major scope changes = new project.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="px-6 pb-4 text-base text-gray-700 leading-relaxed">
                It depends on your rates and project frequency. Entry-level
                creators typically earn $800–$2.7K/month. Growing creators make
                $2.4K–$13.5K+/month. Specialists make $6.4K+/month. See earning
                examples above.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
      ...
      <section className="px-6 py-24 bg-gradient-to-br from-[#F18B6A] via-[#E07A5A] to-[#D06A4A]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-orange-100 mb-10">
            Join AI creators already booking projects every month.
            <br />
            Set your rates. Build your portfolio. Get discovered by studios who
            value quality work.
          </p>
          <Button
            onClick={() => navigate(createPageUrl("CreatorSignup"))}
