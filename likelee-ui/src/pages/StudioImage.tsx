...
export default function StudioImage() {
  ...
  const generateMutation = useMutation({
    ...
    onSuccess: async (result) => {
      ...
      queryClient.invalidateQueries({ queryKey: ["studio", "generations", "image"] });
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: "50%",
        height: "50%",
        background: "radial-gradient(circle, rgba(50, 200, 209, 0.08) 0%, transparent 70%)",
        pointerEvents: "none",
        zIndex: 0,
      }} />
      <div style={{
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold tracking-tight text-white" style={{ textShadow: "0 0 20px rgba(50,200,209,0.3)" }}>
                  AI Image Generator
                </h1>
                <p className="text-[10px] text-[#32C8D1] font-bold uppercase tracking-widest opacity-80">Premium Studio</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 px-4 py-2 bg-white/[0.03] rounded-full border border-white/10 backdrop-blur-md shadow-inner">
              ...
              <span className="text-sm font-bold tracking-tight">
                ...
                <span className="ml-1 text-[10px] text-gray-500 uppercase">credits</span>
              </span>
            </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10 relative z-10">
          <div className="lg:col-span-4 xl:col-span-3 space-y-6">
              ...
              <div className="space-y-6">
                  ...
                  >
                    ...
                    <SelectContent className="bg-[#0A0A14] border-white/10 backdrop-blur-xl">
                      {imageModels.map((model) => (
                        <SelectItem key={model.id} value={model.id} className="focus:bg-[#32C8D1]/10 focus:text-[#32C8D1] py-3">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={imageSize} onValueChange={setImageSize}>
                    ...
                    <SelectContent className="bg-[#0A0A14] border-white/10 backdrop-blur-xl">
                      {imageSizes.map((size) => (
                        <SelectItem key={size.value} value={size.value} className="focus:bg-[#32C8D1]/10 focus:text-white py-2.5">
                ...
                <div className="space-y-4 pt-2">
                  <div className="flex justify-between items-end">
                    ...
                    <span className="text-xl font-bold bg-gradient-to-t from-[#32C8D1] to-white bg-clip-text text-transparent">{numImages}</span>
                  </div>
                  <Slider
                    value={[numImages]}
                  ...
                  <div className="mt-4 space-y-6 p-4 bg-black/20 rounded-2xl border border-white/5 animate-in slide-in-from-top-2 duration-300">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <label className="text-[10px] font-bold uppercase text-gray-400">Guidance</label>
                        <span className="text-xs font-medium text-[#32C8D1]">{guidanceScale.toFixed(1)}</span>
                      </div>
                      <Slider
                        value={[guidanceScale]}
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <label className="text-[10px] font-bold uppercase text-gray-400">Steps</label>
                        <span className="text-xs font-medium text-[#32C8D1]">{numSteps}</span>
                      </div>
                      <Slider
                        value={[numSteps]}
                ...
                <Button
                  ...
                  className={`w-full h-14 rounded-2xl font-bold text-sm tracking-widest uppercase transition-all duration-300 shadow-[0_8px_30px_rgb(0,0,0,0.4)] ${generateMutation.isPending || generatingJobId
            ...
            <div className="p-4 bg-white/[0.02] border border-white/5 rounded-2xl flex items-start gap-4">
              ...
              <div>
                <p className="text-[10px] uppercase font-bold text-gray-500 mb-1">Notice</p>
          ...
          <div className="lg:col-span-8 xl:col-span-9">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex gap-2">
                <Badge variant="outline" className="border-white/5 bg-white/5 text-[10px] uppercase font-bold px-3 py-1">
                  Grid View
                </Badge>
              </div>
            </div>
                ...
                >
                  {gen.status === "completed" && gen.output_urls?.[0] ? (
                    <>
                      ...
                      <div className="p-4 space-y-3">
                        <p className="text-[11px] text-gray-300 leading-relaxed line-clamp-2 font-medium">
                          {gen.input_params?.prompt || "Mysterious generation..."}
                        </p>
                        <div className="flex items-center justify-between pt-1">
                          <div className="flex items-center gap-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-[#32C8D1] shadow-[0_0_8px_#32C8D1]" />
                            <span className="text-[10px] font-black uppercase tracking-tighter text-[#32C8D1]">Ready</span>
                          </div>
                    ...
                    <div className="aspect-[4/5] flex flex-col items-center justify-center text-center p-6 bg-[#04060C]">
                      ...
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#32C8D1] animate-pulse">Evolving</p>
                      <p className="text-[9px] text-gray-600 mt-2 uppercase font-bold">Please wait...</p>
                    </div>
                  )}
                </div>
              ))}
