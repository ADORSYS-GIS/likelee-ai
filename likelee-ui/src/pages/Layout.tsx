                ...
                {!authenticated ? (
                  ...
                  <div className="flex items-center gap-3 ml-4">
                    {currentPageName !== "OrganizationSignup" && (
                      <Link
                        to={dashboardPath}
                        className={`px-6 py-2 text-sm font-bold text-white bg-[#32C8D1] rounded-lg hover:bg-[#2AB8C1] transition-all shadow-sm flex items-center gap-2 ${
                          !profile ? "opacity-70 cursor-wait" : ""
                        }`}
                      >
                        {!profile && (
