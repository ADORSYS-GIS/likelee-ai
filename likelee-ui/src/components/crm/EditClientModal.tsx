...
const EditClientModal = ({
    ...
    if (client) {
      setFormData({
        ...
        next_follow_up_date: client.next_follow_up_date
          ? new Date(client.next_follow_up_date).toISOString().split("T")[0]
          : "",
      });
    }
  }, [client]);
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: t(
          "agencyDashboard.clientCRM.modal.editClient.toasts.updated",
          {
    ...
    onError: (error: any) => {
      toast({
        ...
        description:
          ...
          t("agencyDashboard.clientCRM.modal.editClient.toasts.failed", {
            defaultValue: "Failed to update client",
          }),
        variant: "destructive",
      });
    },
  ...
  const handleSubmit = () => {
    if (!formData.company) {
      toast({
        title: t(
          "agencyDashboard.clientCRM.modal.addClient.errors.missingInfo",
          {
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <p className="text-[11px] font-medium text-amber-700 dark:text-amber-400">
                {t(
                  "agencyDashboard.clientCRM.modal.addClient.errors.mandatory",
                  {
                    defaultValue: "This field is mandatory.",
                  },
                )}
              </p>
            </div>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="Active Client">
                  {t("agencyDashboard.clientCRM.status.Active Client")}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
