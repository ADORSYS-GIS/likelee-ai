          ...
          {isEditing && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  <div className="text-xs font-bold text-gray-700">Gender</div>
                  <Input
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) => setField("height_inches", e.target.value)}
                  />
                </div>
              </div>
              <div className="space-y-1">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="space-y-1">
                  <div className="text-xs font-bold text-gray-700">Country</div>
                  <Input
