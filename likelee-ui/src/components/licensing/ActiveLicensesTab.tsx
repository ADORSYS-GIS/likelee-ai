    ...
    <div className="space-y-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-blue-600 flex items-center gap-2">
              <span className="font-bold border border-blue-200 rounded px-1 text-xs">
                $
              </span>{" "}
              Total Value
            </CardTitle>
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-white p-4 rounded-lg border shadow-sm">
        ...
        >
          ...
          <ToggleGroupItem value="expiring" aria-label="Toggle expiring">
            Expiring
          </ToggleGroupItem>
          <ToggleGroupItem value="expired" aria-label="Toggle expired">
            Expired
          </ToggleGroupItem>
        </ToggleGroup>
      </div>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      <Avatar className="h-9 w-9">
                        ...
                        />
                        <AvatarFallback>
                          {license.talent_name.substring(0, 2)}
                        </AvatarFallback>
                      </Avatar>
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">
                          {license.talent_id.substring(0, 8)}
                        </span>
                      </div>
                    </div>
                  </TableCell>
      ...
      {isDetailsOpen &&
        console.log(
          "Rendering ActiveLicenseDetailsSheet with open=",
          isDetailsOpen,
        )}
