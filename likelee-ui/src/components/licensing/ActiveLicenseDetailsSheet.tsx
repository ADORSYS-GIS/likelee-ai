...
import { Calendar, DollarSign, FileText, User, Briefcase, RefreshCw } from "lucide-react";
...
export const ActiveLicenseDetailsSheet: React.FC<ActiveLicenseDetailsSheetProps> = ({
    license,
    open,
    onClose,
    onRenew,
        ...
        <Sheet open={open} onOpenChange={(val) => !val && onClose()}>
            <SheetContent className="sm:max-w-md overflow-y-auto">
                ...
                <div className="mt-6 space-y-6">
                    ...
                    <div className="flex flex-col items-center justify-center text-center space-y-2 pb-4 border-b">
                        <Avatar className="h-20 w-20 border-2 border-white shadow-sm">
                            ...
                            <AvatarFallback>{license.talent_name.substring(0, 2).toUpperCase()}</AvatarFallback>
                        </Avatar>
                        <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="font-medium text-sm">{license.start_date || "N/A"}</p>
                        </div>
                        <div className="space-y-1">
                            <span className="text-xs text-muted-foreground flex items-center gap-1">
                    ...
                    <div className="bg-indigo-50 p-4 rounded-lg flex justify-between items-center border border-indigo-100">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-indigo-900">Total License Value</span>
                        </div>
                    ...
                    <div className="space-y-3">
                        <h4 className="text-sm font-semibold border-b pb-1">Usage & Rights</h4>

                        <div className="space-y-2">
                            <div>
                                <span className="text-xs text-muted-foreground block">Usage Scope</span>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                                ...
                                <span className={license.days_left && license.days_left < 30 ? "text-orange-600 font-bold" : ""}>
                                    {license.days_left !== undefined ? `${license.days_left} days` : "N/A"}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <SheetFooter className="mt-8">
                    {onRenew && (
                        <Button className="w-full bg-indigo-600 hover:bg-indigo-700" onClick={() => onRenew(license)}>
