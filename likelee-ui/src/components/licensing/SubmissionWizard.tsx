...
export const SubmissionWizard: React.FC<SubmissionWizardProps> = ({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(val) => !val && onClose()}>
            <DialogContent className={`max-w-5xl h-[92vh] p-0 border-none bg-slate-50 rounded-3xl overflow-hidden flex flex-col shadow-2xl transition-all duration-300 ${step === 3 ? "translate-y-full opacity-0 pointer-events-none" : ""}`}>
                        ...
                        <div className="flex items-center justify-between gap-8 mb-8">
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-slate-500 font-medium">
                                    {step === 1 ? "Enter the core details of this licensing deal" : "Review and personalize the contract content"}
                                </p>
                            </div>
                        ...
                        {step === 1 && (
                            <div className="max-w-3xl mx-auto space-y-8 pb-10">
                                    ...
                                    <div className="p-8 bg-white rounded-3xl border border-slate-200/60 shadow-sm space-y-6">
                                        ...
                                        <div className="space-y-4">
                                            <div className="space-y-2">
                                                <Label className="text-sm font-bold text-slate-800 ml-1">Brand Name *</Label>
                                                <Input
                                            ...
                                            <div className="space-y-2">
                                                <Label className="text-sm font-bold text-slate-800 ml-1">Start Date</Label>
                                                <Input
                                                    type="date"
                                                    {...register("start_date")}
                                                ...
                                                >
                                                    ...
                                                    <SelectContent className="rounded-xl border-slate-200">
                                                        {EXCLUSIVITY_OPTIONS.map((opt) => (
                                                            <SelectItem key={opt} value={opt} className="font-medium rounded-lg">{opt}</SelectItem>
                                                        ))}
                                                    </SelectContent>
                                                </Select>
                                            </div>
                                ...
                                <div className="p-8 bg-white rounded-3xl border border-slate-200/60 shadow-sm space-y-4">
                                    <Label className="text-sm font-bold text-slate-800 ml-1">Additional Custom Terms</Label>
                                    <Textarea
                            ...
                            <div className="max-w-4xl mx-auto pb-10">
                                <div className="bg-white rounded-3xl border border-slate-200/60 shadow-sm p-8">
                                    <ContractEditor
                                        ...
                                        format={template.contract_body_format as any || "markdown"}
                                ...
                                <div className="mt-8 p-6 bg-indigo-50/50 border border-indigo-100 rounded-2xl flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-indigo-800/80 leading-relaxed font-medium">
                                            We've automatically replaced all placeholders with your deal specifics.
                                            You can still make quick edits directly in the editor before finalizing.
                                        </p>
                                    </div>
                                </div>
                            </div>
