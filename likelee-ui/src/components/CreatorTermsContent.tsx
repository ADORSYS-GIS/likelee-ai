...
export function CreatorTermsContent() {
  return (
    <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
      ...
      <section>
        <h3 className="text-xl font-bold text-gray-900">2. Definitions</h3>
      ...
      <section>
        ...
        <h4 className="font-semibold text-gray-800">4.1 Consent to License</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-800">4.4 Third-Party Rights</h4>
        <p>
      ...
      <section>
        ...
        <h4 className="font-semibold text-gray-800">7.1 Earnings</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-800">7.2 Platform Fee</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-800">7.3 Payment Schedule</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-800">7.4 Taxes</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-800">7.5 Disputed Payments</h4>
        <p>
      ...
      <section>
        <h3 className="text-xl font-bold text-gray-900">12. Indemnification</h3>
        <p>
      ...
      <section>
        ...
        <h4 className="font-semibold text-gray-800">16.1 Governing Law</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-800">16.3 Arbitration</h4>
        <p>
      ...
      <p>
        ...
        likelee.ai | Empowering the Future of Likeness Licensing
      </p>
    </div>
  );
}
